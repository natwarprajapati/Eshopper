...
function AHeader({container,navclass,styl, carousel}) {
        ...
        <nav className="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
          ...
          <div className="collapse navbar-collapse justify-content-between" id="navbarCollapse">
            <div className="navbar-nav mr-auto py-0">
              <NavLink to="/ahome" className="nav-item nav-link">Home</NavLink>
              <div className="nav-item dropdown">
                <a href="#" className="nav-link dropdown-toggle " data-toggle="dropdown">Shop</a>
                <div className="dropdown-menu rounded-0 m-0 ">
                  <NavLink to="/Addshop" className="dropdown-item ">Add shop</NavLink>
                  <NavLink to="/manageshop" className="dropdown-item">Manage Shop</NavLink>
                </div>
              </div>
              <NavLink to="/Ashopdetails" className="nav-item nav-link">Shop Detail</NavLink>
              <div className="nav-item dropdown">
                <a href="#" className="nav-link dropdown-toggle " data-toggle="dropdown">Pages</a>
                <div className="dropdown-menu rounded-0 m-0 ">
                  <NavLink to="/Acart" className="dropdown-item ">Shopping Cart</NavLink>
                  <NavLink to="/Acheckout" className="dropdown-item">Checkout</NavLink>
                </div>
              </div>
              <NavLink to="/Manageuser" className="nav-item nav-link">Manage users</NavLink>
            </div>
            {
              (
                ()=>{
                  if(localStorage.getItem("adminid"))
                    {return(<><Link  className="nav-item nav-link pr-5">hii {localStorage.getItem("adminname")}</Link>
                     <Link className='nav-item nav-link pr-2' onClick={logout} >LogOut</Link> </>
