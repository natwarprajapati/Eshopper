        ...
        <div className="col-12 pb-1">
          ...
          <div className="card product-item border-0 mb-4" >
            <div className="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
              <img className="img-fluid w-100" style={{height:"400px", width:"200px"}} src={value.pimage} />
            </div>
            <div className="card-body border-left border-right text-center p-0 pt-4 pb-3">
              <h6 className="text-truncate mb-3">{value.pname}</h6>
              <div className="d-flex justify-content-center">
                <h6>${value.pprice}.00</h6><h6 className="text-muted ml-2"><del>${value.poprice}.00</del></h6>
              </div>
            </div>
