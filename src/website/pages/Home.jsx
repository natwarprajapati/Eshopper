...
import Caraousel from '../common_components/Caraousel'
import Footer from '../common_components/Footer'

function Home() {
  return (
    <>
      <Header container="container-fluid mb-5" navclass="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0" carousel={<Caraousel/>}/>
      <div>
  {/* Featured Start */}
